...
import csv
from mmseg.apis import multi_gpu_test, single_gpu_test, single_gpu_tent, single_gpu_tent_test
...
def main():
    ...
    for dataset, data_loader in zip(datasets, data_loaders):
        ...
        outputs = single_gpu_tent_test(model, data_loader, args.show, args.show_dir,
                                efficient_test)
