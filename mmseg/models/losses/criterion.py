...
from ..utils.point_features import point_sample, get_uncertain_point_coords_with_randomness
...
class SetCriterion(nn.Module):
    ...
    def loss_masks(self, outputs, targets, indices, num_masks):
        ...
        target_masks = torch.nn.functional.interpolate(target_masks, scale_factor=0.25*0.25, mode='nearest')
        # ===================================================================================
    ...
    def _get_binary_mask(self, target):
        y, x = target.size()
        target_onehot = torch.zeros(self.num_classes + 1, y, x) #背景做第十五类？
    ...
    def forward(self, outputs, gt_masks):
        ...
        # print(outputs_without_aux["pred_masks"].size(),targets[0]["masks"].size())
